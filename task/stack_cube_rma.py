...
from algo.misc import get_task_id, get_object_id
...
class StackCubeRMA(StackCubeEnv):
    ...
    def _get_obs_state_dict(self):
        ...
        return OrderedDict(
            ...
            obj1_priv_info=flatten_state_dict(OrderedDict(
                        ...
                        obj_density=self.cubeA.mass / 
                                    ((self.box_half_size[0]*2)**3),
            ...
            object2_state=flatten_state_dict(OrderedDict(
                        bbox_size=self.obj2_bbox_size,
                        obj_pose=vectorize_pose(self.cubeB.pose),
                        tcp_to_obj_pos=self.cubeB.pose.p - self.tcp.pose.p,
                    )),
            obj2_priv_info=flatten_state_dict(OrderedDict(
                        obj_scale=self.cube_scale,
                        obj_density=self.cubeB.mass / 
                                    ((self.box_half_size[0]*2)**3),
    ...
    def _initialize_actors(self):
        ...
        phys_mtl1 = self._scene.create_physical_material(
            ...
            dynamic_friction=self.cube1_friction, restitution=0.1
        )
        phys_mtl2 = self._scene.create_physical_material(
            static_friction=self.cube2_friction, 
            dynamic_friction=self.cube2_friction, restitution=0.1
        )
